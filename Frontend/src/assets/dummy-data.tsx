...
export const featuresData = [
    {
        ...
        title: 'Smart Upload',
        desc: 'Drag & drop your assects. We auto-optimize formats and sizes.'
    },
    {
...
export const faqData = [
    {
        ...
        answer: `We leverage Start-of-art diffusion models trained on millions
                 of product images to blend your product into realistic scenes while
                  perserving details, lighting and reflections.`
    },
    {
    ...
    {
        question: 'What imput formats do you support?',
