  ...
  return (
    <div className="relative group">
      <div className={`relative h-64 rounded-2xl border-2
        ...
        items-center justify-center bg-white/2 p-6 ${file ? 'border-violet-600/50 bg-violet-500/50'
         :'border-white/10 hover:border-violet-500/50 hover:bg-white/5'}`}>
          ...
          {file ? (
            ...
            object-cover rounded-xl opacity-60"/>
            ...
            right-4 bg-black/50 backdrop-blur-md p-3 rounded-lg border
            border-white/10">
